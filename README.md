...
In terms of the styling, I initially built it all out in vanilla CSS, but I wanted to also give using the styled-components library a shot so I converted some of what I already had. I spent some time reading up on it, and whilst I didn't convert the whole thing, I managed to implement it on some of the more potentially reusable and complex components such as the buttons and input. I can already tell it's an incredibly versatile and powerful library. whilst my implementation works I'm not sure if it actually any good or is representative of industry standard.

# Going Forward

If I were to take this code test further I'd probably do some more research on styled-components best practices and how to best use it in large scale applications and try to replicate that. I think the other main thing I'd attempt would be some unit testing.